...
const uz = {
  ...
  nav: {
    ...
    items: {
      "/admin/director": "Ko'rsatkichlar",
      "/admin/director/analytics": "Analitika",
      "/admin/director/products": "Mahsulotlar",
      "/admin/director/categories": "Kategoriyalar",
      "/admin/director/discounts": "Chegirmalar",
      "/admin/director/reviews": "Sharhlar",
      "/admin/director/users": "Xodimlar",
      "/admin/director/audit": "Amallar tarixi",
...
const ru: PanelDictionary = {
  ...
  nav: {
    ...
    items: {
      "/admin/director": "Показатели",
      "/admin/director/analytics": "Аналитика",
      "/admin/director/products": "Товары",
      "/admin/director/categories": "Категории",
      "/admin/director/discounts": "Скидки",
      "/admin/director/reviews": "Отзывы",
      "/admin/director/users": "Сотрудники",
      "/admin/director/audit": "История действий",
...
const en: PanelDictionary = {
  ...
  nav: {
    ...
    items: {
      ...
      "/admin/director/analytics": "Analytics",
      "/admin/director/products": "Products",
      "/admin/director/categories": "Categories",
      "/admin/director/discounts": "Discounts",
      "/admin/director/reviews": "Reviews",
      "/admin/director/users": "Staff",
      "/admin/director/audit": "Activity log",
