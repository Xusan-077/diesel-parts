...
export const products: Product[] = [
  {
    ...
    imageUrl: "/seed-images/cat-injector-3126.svg",
  },
  {
    ...
    imageUrl: "/seed-images/komatsu-turbo-pc200.svg",
  },
  {
    id: "volvo-hyp-ec210",
    ...
    imageUrl: "/seed-images/volvo-hyp-ec210.svg",
  },
  {
    ...
    imageUrl: "/seed-images/hitachi-piston-zx330.svg",
  },
  {
    id: "jcb-engine-3cx",
    ...
    imageUrl: "/seed-images/jcb-engine-3cx.svg",
  },
  {
    ...
    imageUrl: "/seed-images/hyundai-track-r210.svg",
  },
  {
    ...
    imageUrl: "/seed-images/doosan-seal-dx225.svg",
  },
  {
    id: "cat-turbo-c15",
    ...
    imageUrl: "/seed-images/cat-turbo-c15.svg",
  },
  {
    ...
    imageUrl: "/seed-images/komatsu-injector-pc300.svg",
  },
  {
    id: "volvo-valve-l120",
    ...
    imageUrl: "/seed-images/volvo-valve-l120.svg",
  },
  {
    ...
    imageUrl: "/seed-images/hitachi-hyp-ex200.svg",
  },
  {
    ...
    imageUrl: "/seed-images/jcb-undercarriage-js220.svg",
  },
  {
    ...
    imageUrl: "/seed-images/hyundai-piston-r220.svg",
  },
  {
    ...
    imageUrl: "/seed-images/doosan-valve-dx140.svg",
  },
  {
    ...
    imageUrl: "/seed-images/cat-transmission-950.svg",
  },
  {
    id: "jcb-seal-3cx",
    slug: "jcb-hydraulic-seal-kit-3cx",
    name: { uz: "JCB 3CX gidravlik zichlagich to'plami", ru: "Комплект гидравлических уплотнений JCB 3CX", en: "JCB 3CX Hydraulic Seal Kit" },
    sku: "DP-SEL-3CX",
    oemNumbers: ["991/00109"],
    price: 760000,
    categoryId: "seal-kit",
    brandId: "jcb",
    description: {
      uz: "JCB 3CX ekskavator-yuklagichlari uchun gidravlik silindr zichlagichlari.",
      ru: "Уплотнения гидроцилиндра для экскаваторов-погрузчиков JCB 3CX.",
      en: "Hydraulic cylinder seal kit for JCB 3CX backhoe loaders.",
    },
    compatibleModels: ["JCB 3CX", "JCB 4CX"],
    stockStatus: "available",
    specs: [
      { label: { uz: "Material", ru: "Материал", en: "Material" }, value: "Nitrile rubber" },
      { label: { uz: "Kafolat", ru: "Гарантия", en: "Warranty" }, value: "6 months" },
    ],
    imageUrl: "/seed-images/jcb-seal-3cx.svg",
  },
  {
    id: "volvo-transmission-l60",
    slug: "volvo-transmission-filter-l60",
    name: { uz: "Volvo L60 transmissiya filtri", ru: "Фильтр трансмиссии Volvo L60", en: "Volvo L60 Transmission Filter" },
    sku: "DP-TRF-L60",
    oemNumbers: ["VOE11412803"],
    price: 480000,
    categoryId: "transmission",
    brandId: "volvo",
    description: {
      uz: "Volvo L60 yuklagichlari uchun transmissiya moyi filtri.",
      ru: "Фильтр трансмиссионного масла для погрузчиков Volvo L60.",
      en: "Transmission oil filter for Volvo L60 loaders.",
    },
    compatibleModels: ["Volvo L60F", "Volvo L60H"],
    stockStatus: "available",
    specs: [
      { label: { uz: "Filtrlash darajasi", ru: "Степень фильтрации", en: "Filtration Rating" }, value: "15 microns" },
      { label: { uz: "Kafolat", ru: "Гарантия", en: "Warranty" }, value: "6 months" },
    ],
    imageUrl: "/seed-images/volvo-transmission-l60.svg",
  },
  {
    id: "hyundai-turbo-r250",
    slug: "hyundai-turbocharger-r250",
    name: { uz: "Hyundai R250 turbokompressori", ru: "Турбокомпрессор Hyundai R250", en: "Hyundai R250 Turbocharger" },
    sku: "DP-TRB-R250",
    oemNumbers: ["28230-4A470"],
    price: 16800000,
    categoryId: "turbocharger",
    brandId: "hyundai",
    description: {
      uz: "Hyundai R250 ekskavatorlari uchun turbokompressor.",
      ru: "Турбокомпрессор для экскаваторов Hyundai R250.",
      en: "Turbocharger for Hyundai R250 excavators.",
    },
    compatibleModels: ["Hyundai R250", "Hyundai R260"],
    stockStatus: "limited",
    specs: [
      { label: { uz: "Tur", ru: "Тип", en: "Type" }, value: "Wastegate" },
      { label: { uz: "Kafolat", ru: "Гарантия", en: "Warranty" }, value: "12 months" },
    ],
    imageUrl: "/seed-images/hyundai-turbo-r250.svg",
  },
  {
    id: "doosan-track-dx225",
    slug: "doosan-track-chain-dx225",
    name: { uz: "Doosan DX225 gusenitsa zanjiri", ru: "Гусеничная цепь Doosan DX225", en: "Doosan DX225 Track Chain" },
    sku: "DP-TRC-DX225",
    oemNumbers: ["2189-1120A"],
    price: 15200000,
    categoryId: "track-chain",
    brandId: "doosan",
    description: {
      uz: "Doosan DX225 ekskavatorlari uchun bardoshli gusenitsa zanjiri.",
      ru: "Прочная гусеничная цепь для экскаваторов Doosan DX225.",
      en: "Heavy-duty track chain for Doosan DX225 excavators.",
    },
    compatibleModels: ["Doosan DX225", "Doosan DX255"],
    stockStatus: "available",
    specs: [
      { label: { uz: "Bo'g'inlar soni", ru: "Количество звеньев", en: "Link Count" }, value: "48" },
      { label: { uz: "Kafolat", ru: "Гарантия", en: "Warranty" }, value: "12 months" },
    ],
    imageUrl: "/seed-images/doosan-track-dx225.svg",
  },
];
