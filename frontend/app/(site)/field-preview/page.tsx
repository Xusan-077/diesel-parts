...
function Panel({ theme }: { theme: string }) {
  ...
  /*
   * True on the client, false in the server snapshot, so the badge below is
   * proof of hydration rather than of server rendering. A subscribe that never
   * fires plus two constant snapshots is the effect-free way to ask this;
   * setting state in an effect body to do the same thing is what
